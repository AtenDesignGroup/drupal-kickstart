 ...
 * read about the setup chosen for GregSiteTheme and specifics of how to configure on a per-project basis.
...
const prefixWrapSelector = '.ck-content';
...
module.exports = {
  plugins: [
    ...
    PrefixWrap(prefixWrapSelector, prefixWrapConfig),
