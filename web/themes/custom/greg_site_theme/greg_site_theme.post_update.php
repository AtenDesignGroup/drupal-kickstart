...
/**
 * @file
 * Post update functions for GregSiteTheme.
 */

/**
 * Enable new theme: stable9.
 */
function greg_site_theme_post_update_install_stable9() {
 ...
 */
function greg_site_theme_post_update_uninstall_stable_classy() {
