...
/**
 * @file
 * Functions to support greg_site_theme theme settings.
 */
 ...
 */
function greg_site_theme_form_system_theme_settings_alter(&$form, FormStateInterface $form_state) {
  /** @var \Drupal\Core\Extension\ThemeSettingsProvider $provider */
  $provider = \Drupal::service(ThemeSettingsProvider::class);

  $form['greg_site_theme_settings'] = [
    '#type' => 'details',
    '#title' => t('Settings'),
    '#open' => TRUE,
    '#weight' => -10,
  ];
  $form['greg_site_theme_settings']['display_back_to_top'] = [
    '#type' => 'checkbox',
  ...
  $form['greg_site_theme_settings']['mobile_menu_slide_direction'] = [
    '#type' => 'select',
