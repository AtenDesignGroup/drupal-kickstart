...
describe('DkStartTheme theme generator', () => {
  beforeEach(() => {});
  ...
  before(function () {
    ...
    if (Cypress.env('skipGeneratorTests')) {
      cy.log(
        'Skipping generator tests in CI - testing dk_start_theme theme directly',
      );
      this.skip();
    }
    ...
    cy.exec(generatorCmd, {
      ...
      // Ensure dk_start_theme specific folders were removed from the generated theme.
